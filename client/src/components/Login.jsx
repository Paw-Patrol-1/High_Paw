...
function Login() {
  return (
    ...
    <div className='parentContainer flex h-screen w-full items-center justify-center bg-cover bg-no-repeat relative'>
      <img
      className='backgroundImage h-full'
      src={pawSteps}
      />
      <form className= ' absolute bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 w-2/5 flex flex-col mx-auto my-20 '>
    ...
    // <div className='parentContainer flex h-screen w-full items-center justify-center bg-cover bg-no-repeat'  >
